...

{
  ...
  "version": 2,
  "securityGroups": [],
  "displayName": "Klaviyo Onsite Tracking",
  ...
  "description": "Klaviyo onsite tracking for hotel booking engines (Cloudbeds, Mews, Guesty) and restaurant ordering (Olo).",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  ...
  },
  {
    "type": "SELECT",
    "name": "hotel_type",
    "displayName": "Which platform do you use?",
    ...
    "help": "Select your booking or ordering platform. Hotels: Cloudbeds, Mews, Guesty. Restaurants: Olo."
  }
]
...
const injectScript = require('injectScript');
  ...
  function initialiseKlaviyoTracking(){
    log('Klaviyo JS loaded, now loading tracking script');
    ...
    } else if (data.hotel_type == "olo"){
      injectScript(
        'https://klaviyo.github.io/klaviyo-hotels-tags/klaviyo_restaurant_tracking_olo.js',
        function() {
          log('Olo tracking script loaded successfully');
          data.gtmOnSuccess();
        },
        function() {
          log('Restaurant tracking script FAILED to load');
          data.gtmOnFailure();
        }
      );
    } else {
